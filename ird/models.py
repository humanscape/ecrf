...
class IrdHistory(models.Model):
    ...
    myodesopsia = models.IntegerField('비문증', choices=YES_NO_DN_CHOICES, null=True, blank=True, help_text='비문증이 있으신가요?')
    ...
    diagnosis_reason = models.TextField(null=True, blank=True, help_text='진단 받은 계기')
    ...
    first_diagnosis_hospital = models.TextField(null=True, blank=True, help_text='첫 진단 병원')
    current_hospital = models.TextField(null=True, blank=True, help_text='현재 다니고 있는 병원')
    other_hospital = models.TextField(null=True, blank=True, help_text='이 외에 내원했던 병원')
    ...
    familyhistory_diagnosis1_name = models.CharField('가족 같은 종류 진단 명', max_length=255, null=True, blank=True,
                                                    help_text='가족 중에서 같은 종류의 유전성 망막질환이 있는 경우 그분의 질병은 무엇인가요?')
    ...
    familyhistory_diagnosis2_name = models.CharField('가족 다른 종류 진단 명', max_length=255, null=True, blank=True,
                                                    help_text='가족 중에서 다른 종류의 유전성 망막질환이 있는 경우 그분의 질병은 무엇인가요?')
    other_diagnosis = models.IntegerField('그외 다른 질환', choices=YES_NO_DN_CHOICES, null=True, blank=True,
                                          help_text='그외 다른 질환이 있나요?')
    other_diagnosis_name = models.CharField('그외 다른 질환 명', max_length=255, null=True, blank=True,
                                            help_text='그 외 다른 질환이 있는 경우 그 질병은 무엇인가요?')
    ...
    eyeglasses_lens_memo = models.TextField('안경, 콘택트 렌즈 관련 기록', null=True, blank=True, help_text='안경이나 콘택트 렌즈를 사용할 경우 추가 기록')
    ...
    cataract_memo = models.TextField('백내장 관련 기록', null=True, blank=True, help_text='백내장이 있을 경우 추가 기록')
    ...
    color_sense_age = models.PositiveIntegerField('색각 경험 나이', null=True, blank=True, help_text='몇 살 때, 색각을 처음 경험하셨나요?')
    ...
    best_va_lt = models.TextField('가장 좋았을때 시력 좌', null=True, blank=True)
    best_va_rt = models.TextField('가장 좋았을때 시력 우', null=True, blank=True)
    best_vfi_lt = models.TextField('가장 좋았을때 시야 좌', null=True, blank=True)
    best_vfi_rt = models.TextField('가장 좋았을때 시야 우', null=True, blank=True)
    ...
    first_vfi_lt = models.TextField('최초 진단시 시야 좌', null=True, blank=True)
    first_vfi_rt = models.TextField('최초 진단시 시야 우', null=True, blank=True)
    ...
    current_vfi_lt = models.TextField('현재 시야 좌', null=True, blank=True)
    current_vfi_rt = models.TextField('현재 시야 우', null=True, blank=True)
