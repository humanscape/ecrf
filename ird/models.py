...
class IrdHistory(models.Model):
    ...
    udva_od = models.CharField('UDVA', max_length=100, null=True, blank=True, help_text='원거리나안시력')
    unva_od = models.CharField('UNVA', max_length=100, null=True, blank=True, help_text='근거리나안시력')
    cdva_od = models.CharField('CDVA', max_length=100, null=True, blank=True, help_text='원거리교정시력')
    cnva_od = models.CharField('CNVA', max_length=100, null=True, blank=True, help_text='근거리교정시력')
    ...
    udva_os = models.CharField('UDVA', max_length=100, null=True, blank=True, help_text='원거리나안시력')
    unva_os = models.CharField('UNVA', max_length=100, null=True, blank=True, help_text='근거리나안시력')
    cdva_os = models.CharField('CDVA', max_length=100, null=True, blank=True, help_text='원거리교정시력')
    cnva_os = models.CharField('CNVA', max_length=100, null=True, blank=True, help_text='근거리교정시력')
