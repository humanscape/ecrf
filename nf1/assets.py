...
RADIO_FIELDS={
    'crf': ( 
        ...
        'hearing_difficulty', 'fasi', 'optic_pathway_glioma', 'vascular_anomaly', 'plexiform_neurofibromas', 
        'plexiform_neurofibromas_3', 'disfigurement', 'aorta_bone_disruption_malignancy', 'painful_accompanying', 'malignancy', 
        'brain_tumor', 'nerve_root_tumor', 'malignant_peripheral_nerve_sheath_tumor', 'moyamoya_disease', 'osteopenia', 
